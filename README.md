...
> **Note**: Create your own `.env` from `.env.example`. If you make any changes to the `.env` file, you must redeploy the application for the changes to take effect. You can do this by running:
